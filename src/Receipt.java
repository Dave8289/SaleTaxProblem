...
public class Receipt {
		...
		try {
			...
			while (input.hasNextLine()) {
				...
				if (splitIndex == -1) {
					...
					float price = Float.parseFloat((line.substring(splitIndex + 2))); // the price is the token after
																						// the substring "at"
	...
	public void calculateTotals() {
		/*
		 * This method runs through the receipt's list of products in order to calculate
	...
	public static int containsItemFromArray(String inputString, String[] items) {
		/*
		 * This method returns the index of which String in items was found in the input
		 * String
	...
	public static BigDecimal round(BigDecimal value, BigDecimal increment, RoundingMode roundingMode) {
		/*
		 * This method handles custom rounding to 0.05, and also sets the BigDecimal
		 * numbers to use 2 decimals
		 * 
		 */
